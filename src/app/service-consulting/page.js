...
import ServiceInsightsPage from "@/components/consulting/insights-consulting";
import ServiceImpactStatsPage from "@/components/consulting/stats-consulting";
import ServiceProblemStatement from "@/components/consulting/problem-statement-consulting";
import ServiceTrendings from "@/components/consulting/trending-consulting";
import ServiceSolutionPage from "@/components/consulting/solution-consulting";
import ContactSectionThree from "@/components/consulting/contact-consulting";
import Header from "@/components/header/Header";
import Home3TestimonialSection from "@/components/consulting/impact-stats-consulting"
import CaseStudyPage from "@/components/consulting/case-studies-consulting"
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.3)), url(assets/img/consulting/banner.jpg)",
        }}
      >
        <svg
          className="vector"
