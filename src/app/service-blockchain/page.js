...
import ServiceInsightsPage from "@/components/Blockchain/insights-blockchain";
import ServiceImpactStatsPage from "@/components/Blockchain/stats-blockchain";
import ServiceProblemStatement from "@/components/Blockchain/problem-statement-blockchain";
import ServiceTrendings from "@/components/Blockchain/trending-blockchain";
import ServiceSolutionPage from "@/components/Blockchain/solution-blockchain";
import Header from "@/components/header/Header";
import Home3TestimonialSection from "@/components/Blockchain/impact-stats-blockchain"
import ContactSectionThree from "@/components/Blockchain/contact-blockchain";
import CaseStudyPage from "@/components/Blockchain/case-studies-blockchain";
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(assets/img/blockchain/banner.jpg)",
        }}
      >
        <svg
          className="vector"
