          ...
          <div className="row">
            <div className="col-lg-12 mb-40">
              <div className="terms-and-conditions">
                ...
                <p>
                  At Rook, a trading name of Rook Private Limited, we are
                ...
                <ul>
                  <li>
                    <strong>i ) Information Collection:</strong> <br />
                    We collect personal information from you when you
                    voluntarily provide it to us, such as when you fill out a
                    contact form or request information about our services. The
                    types of personal information we may collect include your
                    name, email address, phone number, and company name.
                  </li>
                  <li>
                    <strong>ii ) Use of Information:</strong> <br />
                    Outline the process for terminating the consulting agreement
                    and any associated fees or penalties. Include a notice
                    period required for termination.
                  </li>
                  <li>
                    <strong>iii ) Information Sharing:</strong> We do not sell,
                    ...
                    operating our website or conducting our business, as long as
                    they agree to keep your information confidential.
                  </li>
                  <li>
                    <strong>iv ) Data Security:</strong> We implement a variety
                  ...
                  <li>
                    <strong>v ) Cookies:</strong> We use cookies to enhance your
                    browsing experience on our website. You have the option to
                    disable cookies in your browser settings, but please note
                    that some features of our website may not function properly
                    if you do so.
                  </li>
                  <li>
                    <strong>vi ) Third-Party Links:</strong> Our website may
                    contain links to third-party websites. Please be aware that
                  ...
                  <li>
                    <strong>vii ) Changes to Privacy Policy:</strong> We reserve
            ...
            <div className="col-lg-12 mb-40">
              <div className="terms-and-conditions">
                ...
                <ul>
                  <li>
                    <strong>i ) Cookies Usage:</strong> <br />
                    Our website uses cookies to enhance your browsing experience
                    and provide personalized content. Cookies are small text
                    files stored on your device that track, save, and store
                    information about your interactions with our website.
                  </li>
                  <li>
                    <strong>ii ) Types of Cookies:</strong> <br />
                    We use both session cookies and persistent cookies on our
                    website. Session cookies are temporary and are deleted from
                    your device when you close your browser. Persistent cookies
                    remain on your device until they expire or are manually
                    deleted.
                  </li>
                  <li>
                    <strong>iii ) Third-Party Cookies:</strong> We may also
                    allow third-party cookies on our website, such as those from
                    Google Analytics, to collect information about your browsing
                    behavior for analytics purposes. These cookies are subject
                    to the respective third-party privacy policies.
                  </li>
                  <li>
                    <strong>iv ) Cookie Consent:</strong> By using our website,
                    you consent to the use of cookies in accordance with this
                    Cookie Policy. You can manage your cookie preferences
                  ...
                  <li>
                    <strong>v ) Updates to Cookie Policy:</strong> We reserve
                    the right to update or change our Cookie Policy at any time.
                    Any changes will be posted on this page, and your continued
                    use of our website after such changes constitutes your
                    acceptance of the revised Cookie Policy.
                  </li>
                  <li>
                    <strong>vi ) Cookie Control:</strong> You have the option to
                    control and manage cookies through your browser settings.
                    You can choose to accept or reject cookies, or set
                    preferences for specific types of cookies. Please refer to
                    your browser's help documentation for instructions on how to
                    manage cookies.
                  </li>
