...
import ServiceInsightsPage from "@/components/Branding-Marketing/insights-branding-marketing";
import ServiceTrendings from "@/components/Branding-Marketing/trending-branding-marketing";
import ServiceSolutionPage from "@/components/Branding-Marketing/solution-branding-marketing";
import Header from "@/components/header/Header";
import Home3TestimonialSection from "@/components/Branding-Marketing/impact-stats-branding-marketing";
import CaseStudyPage from "@/components/Branding-Marketing/case-studies-branding-marketing";
import ContactSectionThree from "@/components/Branding-Marketing/contact-branding-marketing";
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(assets/img/branding_marketing/banner.jpg)",
        }}
      >
        <svg
          className="vector"
