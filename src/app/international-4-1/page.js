...
import Home2About from "@/components/Rook-fr/features-fr";
import Service4page from "@/components/Rook-fr/work-fr";
import LetsMakeTogetherPage from "@/components/Rook-fr/lets-make-fr";
import Portfolioesonary from "@/components/Rook-fr/portfolio-fr";
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(248, 248, 248, 0.3), rgba(248, 248, 248, 0.3)), url(assets/img/international/france.jpg)",
        }}
      >
        <svg
          className="vector"
              ...
              <div className="row align-items-center gy-5">
                <div className="col-lg-8">
                  <div className="section-title">
                    <h1>
                      Rook Français
                      <span>donner du pouvoir aux entrepreneurs en France</span>
                    </h1>
                  </div>
                  <div className="dash-and-paragraph">
                    ...
                    <p style={{color:"black"}}>
                      Bienvenue chez Rook Français, où nous offrons aux
                      entreprises françaises des outils de pointe, conviviaux et
                      durables basés sur l'IA, conçus pour transformer votre
