...
import Home2About from "@/components/Rook-Britian-1/features-britain";
import Service4page from "@/components/Rook-Britian-1/work-britain";
import LetsMakeTogetherPage from "@/components/Rook-Britian-1/lets-make-britain"
import Portfolioesonary from "@/components/Rook-Britian-1/portfolio-britain"
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(248, 248, 248, 0.3), rgba(248, 248, 248, 0.3)), url(assets/img/international/britain.jpg)",
        }}
      >
        <svg
          className="vector"
              ...
              <div className="row align-items-center gy-5">
                <div className="col-lg-8">
                  <div className="section-title">
                    <h1>
                    Rook Britain <span>Empowering Britain Entrepreneurs</span>
                    </h1>
                  </div>
                  <div className="dash-and-paragraph">
                    ...
                    <p style={{color:"black"}}>
                    Welcome to Rook Britain, where we empower British businesses with cutting-edge, user-friendly, and sustainable AI-driven tools designed to transform the way you do business.
                    </p>
                  </div>
                </div>
