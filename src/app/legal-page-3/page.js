          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="terms-and-conditions">
                ...
                <p>
                  ...
                  agreement between you and Rook.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-12">
              <div className="terms-and-conditions">
                ...
                <p>
                  ...
                  not to engage in any activity that violates applicable laws or
            ...
            <div className="col-lg-12">
              <div className="terms-and-conditions">
                ...
                <p>
                  ...
                  of Rook, a trading name of Rook Private Limited, and is
                  protected by intellectual property laws. "Rook" is a
                  registered trademark of Rook Private Limited.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-12">
              <div className="terms-and-conditions">
                ...
                <p>
                  Rook shall not be liable for any direct, indirect, incidental,
            ...
            <div className="col-lg-12">
              <div className="terms-and-conditions">
                ...
                <p>
                  Our website may contain links to third-party websites. Rook, a
                  trading name of Rook Private Limited, is not responsible for
                  the content or practices of any linked websites.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-12">
              <div className="terms-and-conditions">
                ...
                <p>
                  Rook reserves the right to modify or update these Terms &
