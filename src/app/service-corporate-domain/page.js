...
import ServiceInsightsPage from "@/components/Corporate-domain-name/insights-domain";
import ServiceImpactStatsPage from "@/components/Corporate-domain-name/stats-domain";
import ServiceProblemStatement from "@/components/Corporate-domain-name/problem-statement-domain";
import ServiceTrendings from "@/components/Corporate-domain-name/trending-domain";
import ServiceSolutionPage from "@/components/Corporate-domain-name/solution-domain";
import Header from "@/components/header/Header";
import ContactSectionThree from "@/components/Corporate-domain-name/contact-domain";
import Home3TestimonialSection from "@/components/Corporate-domain-name/impact-stats-domain";
import CaseStudyPage from "@/components/Corporate-domain-name/case-studies-domain";
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)),url(assets/img/Domain/banner.jpg)",
        }}
      >
        <svg
          className="vector"
