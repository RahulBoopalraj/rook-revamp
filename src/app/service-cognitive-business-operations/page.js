...
import Home3TestimonialSection from "@/components/Corporate-business/impact-stats-corporate-business";
import CaseStudyPage from "@/components/Corporate-business/case-studies-corporate-business"
        ...
        <div className="container">
          <div className="banner-wrapper">
            ...
            <ul className="breadcrumb-list">
              ...
              <li>Cognitive Business Operation</li>
            </ul>
          </div>
        </div>
      </div>
