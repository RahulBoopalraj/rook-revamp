...
import Home2About from "@/components/Rook-Francias/features-france";
import Service4page from "@/components/Rook-Francias/work-france";
import LetsMakeTogetherPage from "@/components/Rook-Francias/lets-make-france";
import Portfolioesonary from "@/components/Rook-Francias/portfolio-france";
              ...
              <div className="row align-items-center gy-5">
                <div className="col-lg-8">
                  <div className="section-title">
                    <h1>
                      Rook Français
                      <span>Empowering Entrepreneurs in France</span>
                    </h1>
                  </div>
                  <div className="dash-and-paragraph">
                    ...
                    <p>
                      Welcome to Rook Français, where we empower businesses in
                      France with cutting-edge, user-friendly, and sustainable
                      AI-driven tools designed to transform the way you do
                      business.
                    </p>
                  </div>
                </div>
