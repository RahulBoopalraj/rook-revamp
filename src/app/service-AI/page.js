...
import ServiceInsightsPage from "@/components/AI/insights-ai";
import ServiceImpactStatsPage from "@/components/AI/stats-ai";
import ServiceProblemStatement from "@/components/AI/problem-statement-ai";
import ServiceTrendings from "@/components/AI/trending-ai";
import ServiceSolutionPage from "@/components/AI/solution-ai";
import Header from "@/components/header/Header";
import Home3TestimonialSection from "@/components/AI/impact-stats-ai";
import CaseStudyPage from "@/components/AI/case-studies-ai";
import ContactSectionThree from "@/components/AI/contact-ai";
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(assets/img/AI/banner.jpg)",
        }}
      >
        <svg
          className="vector"
