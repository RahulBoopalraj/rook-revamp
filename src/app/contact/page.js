        ...
        <div className="container-lg container-fluid">
          <div className="section-title six mb-70">
            ...
            <div className="dash-and-paragraph">
              ...
              <p>
              Get in touch with us at Rook for personalized solutions to elevate your Business. We're here to assist with any inquiries or support you need.
              </p>
            </div>
          </div>
                    ...
                    <div className="single-location mb--30">
                      ...
                      <ul>
                        <li>
                          ...
                          <div className="info">
                            <a href="tel:0921772345432">(+91) 709 270 0022
                            </a>
                          </div>
                        </li>
                        <li>
