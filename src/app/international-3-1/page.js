...
import Home2About from "@/components/Rook-Emirates-3-1/features-er";
import Service4page from "@/components/Rook-Emirates-3-1/work-er";
import LetsMakeTogetherPage from "@/components/Rook-Emirates-3-1/lets-make-er"
import Portfolioesonary from "@/components/Rook-Emirates-3-1/portfolio-er"
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(assets/img/international/emirates.jpg)"
        }}
      >
        <svg
          className="vector"
              ...
              <div className="row align-items-center gy-5">
                <div className="col-lg-8">
                  <div className="section-title">
                    ...
                    Rook Emirates<span>تمكين رواد الأعمال في الإمارات</span>
                    </h1>
                  </div>
                  <div className="dash-and-paragraph">
                    ...
                    <p style={{color:"white"}}>
                    مرحبًا بكم في Rook Emirates، حيث نعمل على تمكين الشركات في الإمارات باستخدام أدوات متطورة وسهلة الاستخدام ومستدامة تعتمد على الذكاء الاصطناعي ومصممة لتحويل الطريقة التي تدير بها أعمالك.
                    </p>
                  </div>
                </div>
