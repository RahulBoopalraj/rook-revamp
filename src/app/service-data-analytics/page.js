...
import ServiceInsightsPage from "@/components/data-analytics/insights-data-analytics";
import ServiceImpactStatsPage from "@/components/data-analytics/stats-data-analytics";
import ServiceProblemStatement from "@/components/data-analytics/problem-statement-data-analytics";
import ServiceTrendings from "@/components/data-analytics/trending-data-analytics";
import ServiceSolutionPage from "@/components/data-analytics/solution-data-analytics";
import ContactSectionThree from "@/components/data-analytics/contact-data-analytics";
import Header from "@/components/header/Header";
import Home3TestimonialSection from "@/components/data-analytics/impact-stats-data-analytics";
import CaseStudyPage from "@/components/data-analytics/case-studies-data-analytics";
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(assets/img/data_analytics/banner.jpg)",
        }}
      >
        <svg
          className="vector"
