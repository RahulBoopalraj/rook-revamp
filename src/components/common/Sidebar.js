                ...
                <li className={state.activeMenu==="home"?"active":""}>
                  ...
                  <ul className={`submenu-list ${state.activeMenu==="home"?"active":""}`}>
                    <li className={state.activeMenu==="home"?"active":""}>
                      ...
                      <span className="dropdown-icon2 two"><i className={`bi ${state.activeSubMenu === "light-version" ? "bi-dash" : "bi-plus"}`}   onClick={() => toggleSubMenu("light-version")} /></span>
                      <ul className={`submenu-list ${state.activeSubMenu === "light-version" ? "active" : ""}`}>
                    ...
                    <li className={state.activeSubMenu==="dark-version"?"active":""} >
                      <Link href="/digital-agency-dark">Dark Version</Link>
                      <span className="dropdown-icon2 two"><i className={`bi ${state.activeSubMenu === "dark-version" ? "bi-dash" : "bi-plus"}`}   onClick={() => toggleSubMenu("dark-version")} /></span>
                      <ul className={`submenu-list ${state.activeSubMenu === "dark-version" ? "active" : ""}`}>
                        ...
                        <li><Link href="/personal-portfolio-dark">Personal Portfolio</Link>
                        </li>
