              ...
              <div className="section-title three text-animation">
                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    <p>
                      At Rook, we deliver precise cloud impact stats,
                      highlighting performance gains, efficiency, and cost
                      savings to help businesses maximize cloud benefits.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="home2-process-wrapper">
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        Uptime achieved through our cloud infrastructure
                        management services, ensuring business continuity.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        faster deployment time using our DevOps and Agile
                        Development services, allowing you to bring products to
                        market swiftly.
                      </p>
                    </div>
                  </div>
                ...
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        Savings on average for businesses leveraging our Cloud
                        Cost Management solutions to optimize spending.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        Reduction in the risk of data breaches with Rook’s
                        robust Cloud Security services, offering end-to-end
                        protection for all cloud assets.
                      </p>
                    </div>
                  </div>
                </div>
