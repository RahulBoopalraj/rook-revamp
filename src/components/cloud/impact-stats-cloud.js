            ...
            <div className="row mb-70">
                ...
                <div className="section-title">
                    ...
                    <div className="paragraph-and-btn">
                        <div className="text-animation">
                        <p> At Rook, we deliver precise cloud impact stats,
                      highlighting performance gains, efficiency, and cost
                      savings to help businesses maximize cloud benefits.</p>
                        </div>
                    ...
                    <SwiperSlide className="swiper-slide">
                        ...
                        <div className="row g-lg-4 gy-5">
                            ...
                            <div className="testimonial-img-wrap px-5">
                                ...
                                <img src="assets/img/cloud/stats.jpg" alt="" style={{height:"532px"}}/>
                                </div>
                            </div>
                            </div>
                            <div className="col-lg-7">
                            <div className="testimonial-content-wrapper">
                                <p>Our services ensure exceptional uptime and swift deployment, optimizing cloud costs while significantly reducing the risk of data breaches.</p>
                                ...
                                <li className="single-counter">
                                    ...
                                    <p>Uptime Continuous Cloud Operations</p>
                                    </div>
                                </li>
                                <li className="single-counter">
                                    <div className="content">
                                    ...
                                    <p>Faster Swift Cloud Deployment</p>
                                    </div>
                                </li>
                                <li className="single-counter">
                                    <div className="content">
                                    ...
                                    <p>Savings Optimized Cloud Spending</p>
                                    </div>
                                </li>
                                <li className="single-counter">
                                    <div className="content">
                                    ...
                                    <p>Reduction in Data Breach Risk</p>
                                    </div>
                                </li>
                                </ul>
                            </div>
