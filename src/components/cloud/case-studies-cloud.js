              ...
              <div className="magnetic-wrap">
                <div className="case-study-card">
                  <div className="case-study-img">
                    <img
                      src="assets/img/cloud/cases-1.jpg"
                      alt=""
                    />
                  </div>
                  <div className="case-study-content">
                    ...
                    <p className="pb-4">
                      <strong>Problem: </strong>A growing tech company was
                      facing slow application updates and costly server
                      maintenance, impacting efficiency and scalability.
                    </p>
                    <Link
            ...
            <div className="col-lg-6 col-md-6">
              <div className="magnetic-wrap">
                <div className="case-study-card">
                  <div className="case-study-img">
                    <img
                      src="assets/img/cloud/cases-2.jpg"
                      alt=""
                    />
                  </div>
                  <div className="case-study-content">
                    ...
                    <p>
                      <strong>Problem: </strong> High cloud costs and
