          ...
          <div className="row">
            <div className="col-lg-6 col-md-8">
              <div className="section-title text-animation">
                <h2>Inspired with creativity &amp; Brand Acceleration</h2>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-7">
              <div className="about-content-wrap">
                <div className="about-content">
                  <p>
                  With years of experience in the business industry, Rook takes pride in its ability to provide innovative and high-quality solutions, executed using the cutting edge technology. We are committed to making a significant impact in the business world.
                  </p>
                  <div className="star">
                    <svg
                      width={125}
