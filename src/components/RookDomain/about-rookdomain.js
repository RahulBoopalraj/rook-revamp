        ...
        <div className="row g-4 mb-60">
          ...
          <div className="col-lg-8">
            <div className="section-title two text-animation">
              <h2>We enhance your online presence with the right domain.</h2>
            </div>
          </div>
        </div>
        <div className="row">
          <div className="col-lg-4 d-lg-flex d-none justify-content-end align-items-start">
            <div className="about-left animet-images magnetic-item pt-30">
              <img src="assets/img/Rook-domain/about-1.jpeg" alt="" />
            </div>
          </div>
          <div className="col-lg-8">
            <div className="row g-lg-4 gy-5 align-items-xl-center">
              <div className="col-lg-5">
                <div className="about-right-img animet-images magnetic-item">
                  <img src="assets/img/Rook-domain/about-2.jpeg" alt="" />
                </div>
              </div>
              <div className="col-lg-7">
                <div className="about-content text-animation">
                  <p>
                    Transform your online presence with a domain that speaks
                    directly to your audience's needs and goals. Let us help you
                    find the perfect fit for your digital success.
                  </p>
                  <Link href="/about">
                  Get Rook® Domains
                    <svg
