                ...
                <div className="dash-and-paragraph">
                  ...
                  <div className="paragraph-and-btn">
                    <div className="text-animation">
                      <p>
                        {" "}
                        At Rook, we deliver precise consulting services,
                        focusing on performance optimization, operational
                        efficiency, and cost-effective strategies to help
                      ...
                      <div className="row g-lg-4 gy-5">
                        <div className="col-lg-5">
                          <div className="testimonial-img-wrap px-5">
                            <div className="testimonial-img">
                              <img
                                src="assets/img/consulting/stats.jpg"
                                style={{height:"600px"}}
                                alt=""
                              />
                            </div>
                        ...
                        <div className="col-lg-7">
                          <div className="testimonial-content-wrapper">
                            <p>
                              Our consulting services help businesses enhance
                              strategic decision-making, accelerate
                              time-to-market for new products, and reduce system
                              downtime and maintenance costs, ensuring improved
                              market positioning and reliable performance.
                            </p>
                            <ul className="counter-wrap">
                              ...
                              <li className="single-counter">
                                <div className="content">
                                  ...
                                  <p>Faster Innovation Consulting</p>
                                </div>
                              </li>
                              <li className="single-counter">
                                <div className="content">
