                ...
                <div className="services-btm">
                  ...
                  <div className="paragraph-img">
                    <p>
                      ...
                      A leading company needed to understand evolving market
                      trends and customer preferences to stay ahead of
                      competitors.
                    </p>
                    <p>
                      <h3>
                      ...
                      Rook conducted comprehensive Market Research & Analysis,
                      providing actionable insights and strategic
                      recommendations.
                    </p>
                    <p>
                      <h3>
                      ...
                      The client improved their market positioning and strategic
                      decision-making, leading to a 30% increase in market
                      share.
                    </p>
                  </div>
                  <div className="span" />
                ...
                <div className="services-btm">
                  ...
                  <div className="paragraph-img">
                    <p>
                      ...
                      The company struggled with outdated software architecture that hindered scalability and performance.
                    </p>
                    <p>
                      <h3>
                        <strong>Solution :</strong>
                      </h3>{" "}
                      Solution: Rook provided Software Architecture Consulting, designing a modern, scalable infrastructure that supported growth.
                    </p>
                    <p>
                      <h3>
                        <strong>Impact :</strong>
                      </h3>{" "}
                      The client saw a 40% reduction in system downtime and a 35% improvement in application performance.
                    </p>
                  </div>
                  <div className="span" />
                </div>
