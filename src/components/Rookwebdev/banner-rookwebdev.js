              ...
              <div className="col-lg-12">
                <div className="banner-title text-animation">
                  <h6 className="sub-title">
                    Hlo,<span> We are Rook®</span> , Your Web Dev Partner!
                  </h6>
                  <h1>Startup Vision into Reality.</h1>
                </div>
                    ...
                    <div className="banner-content-and-img">
                      <div className="banner-content">
                        <div className="arrow-and-paragraph">
                          ...
                          <p>
                            Look no further than Rook® WebDev, the ultimate
                            solution for rapidly launching your Web App and
                            making your first dollars online fast.
                          </p>
                        </div>
                        <Link
