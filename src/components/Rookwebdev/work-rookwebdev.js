...
const Portfolioesonary = () => {
  return (
    <>
      <div className="portfolio-page-area portfolio-masonery">
        <div className="container-lg container-fluid">
              ...
              <div className="section-title">
                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    ...
                    <p>
                    Crafting a customer-centric brief for your website is crucial. We focus on understanding your business needs to succeed online.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="row mb-130 gy-lg-5 g-4 justify-content-center">
              ...
              <div className="portfolio-card two magnetic-item">
                <div className="image-and-tag">
                  ...
                  <div className="portfolio-img">
                    <img src="assets/img/Impact-studies/Moufil.jpg" alt="" />
            ...
            <div className="col-lg-6 col-md-6">
              <div className="portfolio-card two magnetic-item">
                <div className="image-and-tag">
                  ...
                  <div className="portfolio-img">
                    <img src="assets/img/Impact-studies/Finequs.jpg" alt="" />
                    <Link className="details-btn" href="/portfolio-details">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={12}
            ...
            <div className="col-lg-6 col-md-6">
              <div className="portfolio-card two magnetic-item">
                <div className="image-and-tag">
                  ...
                  <div className="portfolio-img">
                    <img src="assets/img/Impact-studies/CEC.jpg" alt="" />
                    <Link className="details-btn" href="/portfolio-details">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={12}
            ...
            <div className="col-lg-6 col-md-6">
              <div className="portfolio-card two magnetic-item">
                <div className="image-and-tag">
                  ...
                  <div className="portfolio-img">
                    <img src="assets/img/Impact-studies/caruda.jpg" alt="" />
                    <Link className="details-btn" href="/portfolio-details">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={12}
