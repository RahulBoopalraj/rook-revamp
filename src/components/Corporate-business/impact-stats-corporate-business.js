                      ...
                      <div className="row g-lg-4 gy-5">
                        <div className="col-lg-5">
                          <div className="testimonial-img-wrap">
                            <div className="testimonial-img">
                              <img
                                src="assets/img/cognitive_business/stats.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                        ...
                        <div className="col-lg-7">
                          <div className="testimonial-content-wrapper">
                            <p>
                              Our cognitive business operations boost
                              efficiency, enhance customer satisfaction, and
                              streamline workflows, improving decision-making
                            ...
                            <ul className="counter-wrap">
                              <li className="single-counter">
                                <div className="content">
                                  ...
                                  <p>
                                  Increase Cognitive Automation Efficiency
                                  </p>
                                </div>
                              </li>
                              <li className="single-counter">
                                <div className="content">
                                  ...
                                  <p>Boost AI-Enhanced Satisfaction</p>
                                </div>
                              </li>
                              <li className="single-counter">
                                <div className="content">
                                  ...
                                  <p>Reduction AI-Driven Workflow</p>
                                </div>
                              </li>
                              <li className="single-counter">
                                <div className="content">
                                  ...
                                  <p>Improvement Analytics Speed</p>
                                </div>
                              </li>
                            </ul>
                          </div>
