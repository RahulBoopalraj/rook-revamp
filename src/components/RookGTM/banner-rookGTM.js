            ...
            <div className="col-xxl-8 col-xl-7 col-lg-7 d-flex align-items-center">
              <div className="banner-content-wrap">
                <h1 className="text-animation2">
                  Go-to-Market <span>Efficiently with</span> Automation.
                </h1>
                <div className="banner-content">
                  ...
                  <div className="content-and-btn text-animation">
                    <p>
                      ...
                      market, or looking to refine your existing strategy, our
                      team of experts is here to elevate you.
                    </p>
                    <div className="banner-btn">
                      <a href="tel:+990737621432">
                        ...
                        <span className="content">Get Rook® GTM</span>
