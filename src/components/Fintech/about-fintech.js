      ...
      <div className="container-lg container-fluid">
        <div className="row g-4 mb-60">
          ...
          <div className="col-lg-8">
            <div className="section-title two text-animation">
              <h2>
                We offer innovative banking, lending, payments, wealth
        ...
        <div className="row">
          <div className="col-lg-4 d-lg-flex d-none justify-content-end align-items-start">
            ...
            <img src="/assets/img/Industries_Fintech/about-1.jpeg" alt="" style={{borderRadius:"10px"}} />
          ...
          <div className="col-lg-8">
            <div className="row g-lg-4 gy-5 align-items-xl-center">
              <div className="col-lg-5">
                ...
                <img src="/assets/img/Industries_Fintech/about-2.jpg" alt="" style={{borderRadius:"10px"}} />
              ...
              <div className="col-lg-7">
                <div className="about-content text-animation">
                  <p>
                    we revolutionize financial services with cutting-edge
                    technology and data-driven insights to drive innovation,
                    growth, and superior customer experiences across banking,
