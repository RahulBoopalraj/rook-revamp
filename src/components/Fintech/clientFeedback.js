        ...
        <div className="row g-4">
          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              <h2>Meet Our Financial Services Clients</h2>
              <div className="dash-and-paragraph two">
                ...
                <p>
                  Rook guides clients with innovative financial solutions and
              ...
              <div className="swiper-wrapper">
                  ...
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Accelerating Financial Innovation</span>
                        <p>
                          Rook® for Fintech has been crucial in driving our
                          innovation. Their tailored solutions and strategic
                          insights have enabled us to stay ahead in the
                          competitive financial landscape with remarkable
                          efficiency.
                        </p>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Enhancing Market Reach</span>
                        <p>
                          "Thanks to Rook® for Fintech, our market reach has
                          expanded significantly. Their expertise in digital
                          transformation and market strategies has substantially
                          boosted our brand recognition and customer
                          acquisition."
                        </p>
                        <div className="author-area">
                          <div className="content">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Revolutionizing Financial Operations</span>
                        <p>
                          "Rook® for Fintech's cutting-edge solutions and
                          strategic guidance have revolutionized our operations.
                          Their support has been pivotal in achieving
                          operational excellence and exceeding our growth
                          targets."
                        </p>
                        <div className="author-area">
                          <div className="content">
                            <h6>Ravichandran</h6>
                            <span>Founder & CEO, Ravin
                            </span>
                          </div>
                        </div>
                      </div>
