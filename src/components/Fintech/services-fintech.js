              ...
              <div className="row mb-80 g-lg-0 gy-5 justify-content-between ">
                <div className="col-lg-5">
                  <div className="single-work magnetic-item">
                    <div className="work-img">
                      <img
                        src="assets\img\Industries_Fintech/service-1.jpg"
                        style={{ height: "360px" , borderRadius: "5px" }}
                        alt=""
                      />
                    </div>
                    <div className="work-content">
                      <div className="content-wrap">
                        <h5>
                          <Link href="/portfolio-details">Retail Banking </Link>
                        </h5>
                        <ul>
                          <li>
                ...
                <div className="col-lg-6">
                  <div className="single-work magnetic-item">
                    <div className="work-img">
                      <img
                        src="assets\img\Industries_Fintech/service-2.jpg"
              ...
              <div className="row mb-80 g-lg-0 gy-5 justify-content-between">
                <div className="col-lg-12">
                  <div className="single-work magnetic-item">
                    ...
                    >
                      <img
                        src="assets\img\Industries_Fintech/service-3.jpg"
                        alt=""
                        style={{
                          width: "100%",
                          height: "100%",
              ...
              <div className="row  g-lg-0 gy-5 justify-content-between" >
                <div className="col-lg-6" >
                  <div className="single-work magnetic-item">
                    <div className="work-img" >
                      <img
                        src="assets\img\Industries_Fintech/service-4.jpg"
                ...
                <div className="col-lg-5">
                  <div className="single-work magnetic-item">
                    <div className="work-img">
                      <img
                        src="/assets/img/Industries_Fintech/service-5.jpg"
                        alt=""
                    ...
                    <div className="work-content">
                      <div className="content-wrap">
                        <h5>
                          <Link href="/portfolio-details">Payments</Link>
                        </h5>
                        <ul>
                          <li>
          ...
          <div className="row">
            <div className="col-lg-12 d-flex align-items-center justify-content-between gap-4 flex-wrap text-animation">
              <div className="section-title scroll-sec-title-end">
                ...
                <p>
                  We enable our clients to lead the financial sector with
                  customized solutions, including fintech innovations, secure
                  banking practices, sustainable investments, and creative
                  banking tactics.
                </p>
              </div>
