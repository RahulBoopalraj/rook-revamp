                ...
                <div className="dash-and-paragraph">
                  ...
                  <div className="paragraph-and-btn">
                    <div className="text-animation">
                      <p>
                        {" "}
                        At Rook, we deliver precise corporate domain name
                        service stats, highlighting improved brand visibility,
                        security, and credibility to help businesses establish a
                      ...
                      <div className="row g-lg-4 gy-5">
                        ...
                        <div className="col-lg-7">
                          <div className="testimonial-content-wrapper">
                            <p>
                              Our Domain Management services ensure minimal
                              downtime, faster registration, enhanced client
                              satisfaction, and improved domain security to
                            ...
                            <ul className="counter-wrap">
                              <li className="single-counter">
                                <div className="content">
                                  ...
                                  <p>
                                  Client Domain Strategy Satisfaction
                                  </p>
                                </div>
                              </li>
                              <li className="single-counter">
                                <div className="content">
                                  ...
                                  <p>Faster Domain Registration</p>
                                </div>
                              </li>
                              <li className="single-counter">
                                <div className="content">
                                  <div className="number">
                                    ...
                                    <h3 className="counter">99.8</h3>
                                    <span>%</span>
                                  </div>
                                  <p>Reduction Domain Downtime</p>
                                </div>
                              </li>
                              <li className="single-counter">
                                <div className="content">
