                  ...
                  <div className="paragraph-and-btn">
                    <div className="text-animation">
                      <p>
                        ...
                        enterprise platforms, focusing on performance
                        enhancements and actionable insights to drive strategic
                        business decisions.
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="row g-lg-4 gy-5">
                        <div className="col-lg-5">
                          <div className="testimonial-img-wrap px-4">
                            <div className="testimonial-img">
                              <img
                                src="assets/img/Enterprise_platforms/stats.jpg"
                                style={{height:"600px"}}
                                alt=""
                              />
                            </div>
                        ...
                        <div className="col-lg-7">
                          <div className="testimonial-content-wrapper">
                            <p>
                              Our enterprise platforms enhance efficiency and
                              accelerate market entry while improving user
                              satisfaction and reducing implementation time.
                            </p>
                            <ul className="counter-wrap">
                              <li className="single-counter">
                                <div className="content">
                                  ...
                                  <p>
                                  Improvement Enterprise Efficiency
                                  </p>
                                </div>
                              </li>
                              <li className="single-counter">
                              ...
                              <li className="single-counter">
                                <div className="content">
                                  ...
                                  <p>Reduction Implementation Time</p>
                                </div>
                              </li>
                              <li className="single-counter">
                                <div className="content">
                                  ...
                                  <p>Increase User Satisfaction</p>
                                </div>
                              </li>
                            </ul>
                          </div>
