              ...
              <div className="section-title three text-animation">
                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    <p>
                      At Rook, we provide key statistics and impacts for
                      enterprise platforms, focusing on performance enhancements
                      and actionable insights to drive strategic business
                      decisions.
                    </p>
                  </div>
                </div>
              ...
              <div className="home2-process-wrapper">
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong>Improvement in operational efficiency </strong>{" "}
                        through our custom software solutions, streamlining
                        processes and reducing manual tasks.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong>faster time-to-market </strong> with our MVP
                        Development, enabling rapid validation and iteration of
                        your product ideas.
                      </p>
                    </div>
                  </div>
                ...
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong>Increase in user satisfaction </strong> from
                        targeted User Testing & Feedback, leading to more
                ...
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong>Reduction in implementation time </strong> for
                        custom software solutions, ensuring quicker adaptation
