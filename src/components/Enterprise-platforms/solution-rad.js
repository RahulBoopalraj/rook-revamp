        ...
        <div className="row g-4 mb-60 ">
          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              <h2>Transform Your Development Process with Rook’s RAD Innovations</h2>
              <div className="dash-and-paragraph">
                <div className="dash" />
                <p>
                  Adapt and thrive in a fast-paced environment with our
                  cutting-edge solutions tailored for your success.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="row g-lg-4 gy-5">
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Foster seamless teamwork with tools designed to streamline
                  communication <br /> and integrate effortlessly into your
                  organization's existing workflows.
                </p>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                <h3>Flexible <br /> Scalability
                </h3>
                <p>
                Adapt your systems effortlessly as you expand, with customizable options that allow you to manage hierarchies and workflows at any level of growth.
                </p>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                Ensure your information remains confidential and secure with our advanced data protection measures and state-of-the-art encryption technologies.
                </p>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                Achieve your goals efficiently with a user-friendly interface that combines functionality, interactivity, and visual appeal for an engaging experience.
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                <h3>Accelerated Deployment
                </h3>
                <p>
                Reduce development time and enhance productivity by utilizing our extensive library of over 1600+ pre-built frameworks to deliver solutions rapidly.
                </p>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                Build applications that adhere to industry standards and user privacy regulations, ensuring alignment with enterprise policies and legal requirements.
                </p>
