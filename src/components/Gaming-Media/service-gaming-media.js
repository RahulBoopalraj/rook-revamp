                  ...
                  <div className="single-work magnetic-item">
                    ...
                    <div className="work-content">
                      <div className="content-wrap">
                        ...
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery"> Design</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Production</Link>
                          </li>
                          <li>
                  ...
                  <div className="single-work magnetic-item">
                    ...
                    <div className="work-content">
                      <div className="content-wrap">
                        ...
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery">Processing</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Compression</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Streaming</Link>
                          </li>
                        </ul>
                        <div className="view-details-wrap">
                          <Link href="/portfolio-details" className="active">
                ...
                <div className="col-lg-12">
                  <div className="single-work magnetic-item">
                    ...
                    <div className="work-content">
                      <div className="content-wrap">
                        <h5>
                          <Link href="/portfolio-details">AR & VR</Link>
                        </h5>
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery">Immersion</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Interaction</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Simulation</Link>
                          </li>
                        </ul>
                        <div className="view-details-wrap">
                          <Link href="/portfolio-details" className="active">
                ...
                <div className="col-lg-6">
                  <div className="single-work magnetic-item">
                    ...
                    <div className="work-content">
                      <div className="content-wrap">
                        <h5>
                          <Link href="/portfolio-details">Cloud Gaming</Link>
                        </h5>
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery">Streaming</Link>
                          ...
                          <li>
                            <Link href="/portfolio-manonery">Scalability</Link>
                          </li>
                          <li>
                  ...
                  <div className="single-work magnetic-item">
                    ...
                    <div className="work-content">
                      <div className="content-wrap">
                        <h5>
                          <Link href="/portfolio-details">
                            Digital Marketing and Monetization
                          </Link>
                        </h5>
                        <ul>
                          <li>
                          ...
                          <li>
                            <Link href="/portfolio-manonery">Analytics</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Revenue</Link>
                          </li>
                        </ul>
                        <div className="view-details-wrap">
                          <Link href="/portfolio-details" className="active">
