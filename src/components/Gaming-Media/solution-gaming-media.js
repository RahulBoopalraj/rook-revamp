          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              ...
              <div className="dash-and-paragraph">
                <div className="dash" />
                <p>
                  Innovative solutions shaping the future of media content
                  creation and distribution, driven by AI advancements and
            ...
            <ul className="solution-img-wrapper text-animation">
              <li className="active">
                <div
                  ...
                  style={{
                    backgroundImage: "url(assets/img/Industries_Gaming_Media/solution-1.jpeg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Gaming_Media/solution-2.jpg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Gaming_Media/solution-3.jpg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Gaming_Media/solution-4.jpg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Gaming_Media/solution-5.jpg)",
                  }}
                ></div>
              </li>
            </ul>
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Creating immersive virtual worlds where users interact and
                      engage, redefining digital experiences beyond traditional
                      gaming.
                    </p>
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Using advanced AI to customize content, ads, and gaming
                      experiences based on user preferences and real-time data,
                      boosting engagement.
                    </p>
                    <Link className="explore-btn" href="/service-details">
                      Explore More
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Implementing blockchain for owning and trading digital
                      assets (NFTs) in games, offering unique in-game items.
                    </p>
                    <Link className="explore-btn" href="/service-details">
                      Explore More
                      <svg
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Extending cloud gaming platforms for streaming
                      high-quality games across devices without needing powerful
                      hardware.
                    </p>
                    <Link className="explore-btn" href="/service-details">
                      Explore More
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Integrating AR to blend digital elements with real-world
                      environments, enhancing interactive gameplay experiences.
                    </p>
                    <Link className="explore-btn" href="/service-details">
                      Explore More
                      <svg
