        ...
        <div className="row g-4">
          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              <h2>Meet our Media & Gaming Clients</h2>
              <div className="dash-and-paragraph two">
                ...
                <p>
                  Rook leads clients with groundbreaking gaming and media
                  solutions, driving immersive experiences and industry
                  innovation.
                </p>
              </div>
            </div>
              ...
              <div className="swiper-wrapper">
                  ...
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Elevating Interactive Experiences</span>
                        <p>
                          “Rook® for Media and Gaming has been a game-changer
                          for our projects. Their cutting-edge solutions and
                          innovative approaches have dramatically enhanced user
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Transforming Digital Entertainment</span>
                        <p>
                          “Thanks to Rook® for Media and Gaming, our digital
                          entertainment offerings have reached new heights.
                          Their expertise in gaming technologies and media
                          strategies has significantly broadened our audience
                          and impact.”
                        </p>
                        <div className="author-area">
                          <div className="content">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Revolutionizing Gaming and Media</span>
                        <p>
                          “Rook® for Media and Gaming’s advanced solutions and
                          strategic insights have revolutionized our approach to
                          content creation and distribution. Their support has
                          been crucial in achieving groundbreaking results and
                          elevating our brand.”
                        </p>
                        <div className="author-area">
                          <div className="content">
