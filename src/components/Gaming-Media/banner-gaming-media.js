          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="banner-main-title">
                <h6 className="text-animation">Media & Gaming
                ...
                <h1 className="text-animation"><span>Dynamic</span>Digital Entertainment.</h1>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-7 d-lg-flex d-none">
                <div className="banner-img magnetic-item">
                  <img src="assets/img/Industries_Gaming_Media/banner.jpg" alt="" />
                </div>
              </div>
              <div className="col-lg-5">
                <div className="banner-right-content">
                  <div className="content">
                    <p>Empower success with seamless
                      <span> media and gaming experiences.</span> Rook maximizes growth through continuous innovation. Ensure audiences remain engaged and satisfied.
                    </p>
