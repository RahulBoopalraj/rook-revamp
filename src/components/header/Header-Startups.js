          ...
          <ul className="menu-list">
            ...
            <li className="menu-item-has-children">
              ...
              <ul className="sub-menu">
                ...
                <li><Link href="/Who-we-Partners-with">Who We Partner <br /> With ?</Link></li>
              </ul>
            </li>
...
{/* 
            ...
            {/*  */}
            <li className="menu-item-has-children">
              <a href="#" className="drop-down">Discover</a><i className="bi bi-plus dropdown-icon" />
              <svg xmlns="http://www.w3.org/2000/svg" width={18} height={10} viewBox="0 0 18 10">
                <path d="M18 4.95V10H13.0154V8.62143H15.7362L10.6962 3.50714L6.59769 7.65714L0 0.978571L0.962308 0L6.59769 5.71429L10.6962 1.56429L16.6154 7.57857V4.95H18Z" />
              </svg>
              <ul className="sub-menu">
                <li><Link href="/discover1">Rook For D2C</Link></li>
                <li><Link href="/discover2">Rook For Startups</Link></li>
                <li><Link href="/discover3">Rook Web Dev</Link></li>
                <li><Link href="/discover4">Rook Branding </Link></li>
...
<li className="menu-item-has-children">
              ...
              <ul className="sub-menu">
                ...
                <li><Link href="/industries7">Construction, <br />Distribution,Hospitality</Link></li>
                <li><Link href="/service-details">Service Details</Link></li>
              </ul>
            </li>
{/* service section */}
<li className="menu-item-has-children">
              <a href="#" className="drop-down">What We Do ?</a><i className="bi bi-plus dropdown-icon" />
              <svg xmlns="http://www.w3.org/2000/svg" width={18} height={10} viewBox="0 0 18 10">
                <path d="M18 4.95V10H13.0154V8.62143H15.7362L10.6962 3.50714L6.59769 7.65714L0 0.978571L0.962308 0L6.59769 5.71429L10.6962 1.56429L16.6154 7.57857V4.95H18Z" />
              </svg>
              <ul className="sub-menu">
...
<li className="menu-item-has-children">
              <a href="#" className="drop-down">Where in the World?</a><i className="bi bi-plus dropdown-icon" />
              <svg xmlns="http://www.w3.org/2000/svg" width={18} height={10} viewBox="0 0 18 10">
                <path d="M18 4.95V10H13.0154V8.62143H15.7362L10.6962 3.50714L6.59769 7.65714L0 0.978571L0.962308 0L6.59769 5.71429L10.6962 1.56429L16.6154 7.57857V4.95H18Z" />
              </svg>
              <ul className="sub-menu">
        ...
        <div className="nav-right d-flex jsutify-content-end align-items-center">
          <div className="sidebar-btn" onClick={toggleMenu}>
            <svg className="open" xmlns="http://www.w3.org/2000/svg" width={18} height={18} viewBox="0 0 18 18">
