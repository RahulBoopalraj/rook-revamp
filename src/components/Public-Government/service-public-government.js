                  ...
                  <div className="single-work magnetic-item">
                    ...
                    <div className="work-content">
                      <div className="content-wrap">
                        <h5>
                          <Link href="/portfolio-details">Public Safety</Link>
                        </h5>
                        <ul>
                          <li>
                          ...
                          <li>
                            <Link href="/portfolio-manonery">Response</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Protection</Link>
                          </li>
                        </ul>
                ...
                <div className="col-lg-6">
                  <div className="single-work magnetic-item">
                    ...
                    <div className="work-content">
                      <div className="content-wrap">
                        <h5>
                          <Link href="/portfolio-details">Infrastructure</Link>
                        </h5>
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery">
                          ...
                          <li>
                            <Link href="/portfolio-manonery">Resilience</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">
                              Sustainability
                    ...
                    <div className="work-content">
                      <div className="content-wrap">
                        ...
                        <ul>
                          ...
                          <li>
                            <Link href="/portfolio-manonery">Efficiency</Link>
                          </li>
                        </ul>
                        <div className="view-details-wrap">
                          <Link href="/portfolio-details" className="active">
                    ...
                    <div className="work-content">
                      <div className="content-wrap">
                        ...
                        <ul>
                          ...
                          <li>
                            <Link href="/portfolio-manonery">Connectivity</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">
                              Sustainability
                  ...
                  <div className="single-work magnetic-item">
                    ...
                    <div className="work-content">
                      <div className="content-wrap">
                        ...
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery">Support</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Equity</Link>
                          </li>
                          <li>
          ...
          <div className="row">
            <div className="col-lg-12 d-flex align-items-center justify-content-between gap-4 flex-wrap text-animation">
              <div className="section-title scroll-sec-title-end">
                ...
                <p>
                  We digitize services, enhance safety, and modernize
                  infrastructure at rook. We also innovate smart cities and
                  social services for better community support.
                </p>
              </div>
