            ...
            <div className="col-lg-12">
              <div className="banner-main-title">
                ...
                <h1 className="text-animation">
                  <span>Unity </span>Through Governance
                </h1>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-lg-7 d-lg-flex d-none pt-3">
                <div className="banner-img magnetic-item pt-3">
                  <img src="assets/img/Industries_Public_Government/banner.jpg" alt="" style={{height:"400px", width:"1000px"}}/>
                </div>
              </div>
              <div className="col-lg-5 pt-3">
                <div className="banner-right-content">
                  <div className="content">
                    <p>
                      At Rook, we innovate public and government sectors,
                      empowering stronger communities and shaping future
                      governance.
                    </p>
