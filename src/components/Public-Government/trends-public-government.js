        ...
        <div className="row g-4 mb-60 ">
          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              <h2>What’s Current and Future Trends in Public & Government</h2>
              <div className="dash-and-paragraph">
                <div className="dash" />
                <p>
                  Discover how our specialized solutions empower public and
                  government sectors to achieve operational excellence and drive
                  meaningful progress.
                </p>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Governments are adopting digital platforms and smart tech,
                  with future trends including expanded AI and IoT in urban
                  systems.
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> AI
                  </li>
                  <li>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Emphasis on green infrastructure and eco-friendly planning,
                  with future trends focusing on renewable energy and
                  sustainable transport.
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> Renewables
                  </li>
                  <li>
                    <i className="bi bi-plus" />
                    Eco-Friendly
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Big data enhances public services, with future trends in
                  predictive analytics and real-time data for proactive
                  policies.
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> Big Data
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Predictive
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Real-Time
                  </li>
                </ul>
              </div>
            </div>
