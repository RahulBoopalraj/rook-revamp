          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              ...
              <div className="dash-and-paragraph">
                <div className="dash" />
                <p>
                  Advanced solutions shaping public governance, fueled by smart
            ...
            <ul className="solution-img-wrapper text-animation">
              <li className="active">
                <div
                  ...
                  style={{
                    backgroundImage: "url(assets/img/Industries_Public_Government/solution-1.jpg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Public_Government/solution-2.jpg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Public_Government/solution-3.jpeg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Public_Government/solution-4.jpeg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Public_Government/solution-5.jpeg)",
                  }}
                ></div>
              </li>
            </ul>
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Enhancing urban living with IoT and smart grids for
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Improving safety with advanced surveillance and efficient
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Ensuring adherence to regulations and managing risks with
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Streamlining public services and feedback through online
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Modernizing cities with smart technologies and sustainable
                      planning.
                    </p>
                    <Link className="explore-btn" href="/service-details">
                      Explore More
