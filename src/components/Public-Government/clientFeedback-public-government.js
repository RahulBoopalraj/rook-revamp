        ...
        <div className="row g-4">
          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              <h2>Meet our Pubic & Government Clients</h2>
              <div className="dash-and-paragraph two">
                ...
                <p>
                  Rook leads public and government sectors with cutting-edge
                  solutions, enhancing service delivery and driving operational
                  excellence.
                </p>
              </div>
            </div>
              ...
              <div className="swiper-wrapper">
                  ...
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Improving Public Services</span>
                        <p>
                          “Rook® for Public and Government has significantly
                          enhanced our public service delivery. Their innovative
                          solutions and strategic insights have streamlined
                          operations and improved citizen engagement.”
                        </p>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Boosting Public Safety</span>
                        <p>
                          “With Rook® for Public and Government, our safety
                          protocols have become more robust and responsive.
                          Their advanced technologies and strategic approach
                          have greatly increased our effectiveness in protecting
                          the community.
                        </p>
                        <div className="author-area">
                          <div className="content">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Advancing Government Operations</span>
                        <p>
                          “Rook® for Public and Government has modernized our
                          administrative processes. Their digital solutions and
                          operational strategies have been instrumental in
                          improving efficiency and transparency in our
                          operations.”
                        </p>
                        <div className="author-area">
                          <div className="content">
