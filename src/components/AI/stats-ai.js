              ...
              <div className="section-title three text-animation">
                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    <p>
                      At Rook, we deliver key AI impacts and stats, highlighting performance enhancements, automation, and actionable insights to drive smarter business decisions.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="home2-process-wrapper">
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong>Increase in customer engagement </strong>achieved through our Enterprise AI solutions with AI-driven personalization, enhancing user experiences and boosting interaction rates.
                ...
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong> Reduction in operational costs </strong>or businesses implementing our Next-Gen AI technologies, streamlining processes and improving efficiency.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong>faster time-to-market</strong> with our AI Integration and Deployment services, enabling quicker adoption of AI solutions and accelerating innovation.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong>  Improvement in decision-making accuracy </strong>using our AI Strategy and Consulting services, leading to more informed and strategic business choices.
                      </p>
                    </div>
                  </div>
                </div>
