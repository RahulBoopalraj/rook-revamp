              ...
              <div className="section-title">
                ...
                <div className="dash-and-paragraph">
                  ...
                  <div className="paragraph-and-btn">
                    <div className="text-animation">
                      <p>
                         At Rook, we deliver key AI impacts and stats,
                        highlighting performance enhancements, automation, and
                      ...
                      <div className="row g-lg-4 gy-5">
                        ...
                        <div className="col-lg-7">
                          <div className="testimonial-content-wrapper">
                            <p>
                              Our AI solutions significantly boost customer
                              engagement and streamline operations while
                              reducing costs. We accelerate time-to-market with
                              rapid AI integration and enhance decision-making
                              accuracy through expert consulting.
                            </p>
                            <ul className="counter-wrap">
                              ...
                              <li className="single-counter">
                                <div className="content">
                                  ...
                                  <p>Reduction AI Operational Costs</p>
                                </div>
                              </li>
                              <li className="single-counter">
                                <div className="content">
                                  ...
                                  <p>Improvement AI Decision-Making</p>
                                </div>
                              </li>
                            </ul>
                          </div>
