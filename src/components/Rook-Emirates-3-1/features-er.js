              ...
              <div className="section-title three text-animation">
                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    <p>
                    نحن نقدم تصميمات مبتكرة مع أدوات مميزة، وأجهزة قابلة للارتداء، وتخطيطات شبكية تفاعلية، مما يعزز تفاعل المستخدم عبر موقعك
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <li className="single-counter">
                    ...
                    <div className="content">
                      <div className="number">
                        <h3 className="counter">الإبداع</h3>
                      </div>
                      <p> نبتكر منتجات وعلامات تجارية جديدة بمنظور هجين للمستقبل.</p>
                    </div>
                  </li>
                  <li className="single-counter">
                    <div className="icon">
                    ...
                    <div className="content">
                      <div className="number">
                        <h3 className="counter">رأس الصفحة والشريط الجانبي</h3>
                      </div>
                      <p> أدواتنا الرقمية وأجهزة metaverse تجعل موقعك فريدًا</p>
                    </div>
                  </li>
                  <li className="single-counter">
                    <div className="icon">
                    ...
                    <div className="content">
                      <div className="number">
                        <h3 className="counter">أشرطة التنقل</h3>
                      </div>
                      <p>تصميماتنا الشبكية تعزز تفاعل المستخدم بعناصر اجتماعية مميزة.</p>
                    </div>
                  </li>
                </ul>
                <Link href="/about">
                  ...
                  <span className="content">About Rook</span>
              ...
              <div className="row g-4">
                <div className="col-sm-5">
                  <div className="about-left">
                    ...
                    نحن نبتكر منتجات وتصميمات من الجيل التالي مع أدوات مميزة وأجهزة قابلة للارتداء، مما يعزز المشاركة من خلال تخطيطات الشبكة والعناصر الاجتماعية
                    </p>
                  </div>
                </div>
