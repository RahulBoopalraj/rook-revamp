          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="section-title text-animation">
                <h2>
                  رائعًا معًا <strong>لنصنع شيئًا</strong>
                </h2>
                <div className="dash-and-paragraph">
                  <div className="dash" />
                  <div className="content-and-social">
                    <p>
                      باستخدام أحدث أساليب التصميم المبتكرة وأحدث التقنيات،
                      سننشئ موقعًا إلكترونيًا يمثل علامتك التجارية حقًا ويجعلك
                      متميزًا عن المنافسين. لنبدأ رحلتك نحو النجاح مع Rook
                      Emirates.
                    </p>
                    <Link
                      href="/contact"
