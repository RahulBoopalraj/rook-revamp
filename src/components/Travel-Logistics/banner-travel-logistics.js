            ...
            <div className="col-lg-12">
              <div className="banner-main-title">
                ...
                <h1 className="text-animation">
                  <span>Discover. </span>Move. Connect.
                </h1>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-lg-7 d-lg-flex d-none">
                <div className="banner-img magnetic-item">
                  <img src="assets/img/Industries_Travel_Logistics/banner.jpg" alt="" 
              ...
              <div className="col-lg-5">
                <div className="banner-right-content">
                  <div className="content">
                    <p>
                      Rook offers cutting-edge travel and logistics solutions to
                      ensure seamless and efficient journeys.
                    </p>
