            ...
            <div className="col-lg-12">
              <div className="row mb-80 g-lg-0 gy-5 justify-content-between ">
                <div className="col-lg-5">
                  <div className="single-work magnetic-item">
                    <div className="work-img">
                      <img src="assets/img/Industries_Travel_Logistics/service-1.jpg" alt="" 
                      style={{height:"490px"}}/>
                    </div>
                    <div className="work-content">
                      <div className="content-wrap">
                        <h5>
                          <Link href="/portfolio-details">Aviation</Link>
                        </h5>
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery"> Airlines</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Navigation</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Fleet</Link>
                          </li>
                        </ul>
                ...
                <div className="col-lg-6">
                  <div className="single-work magnetic-item">
                    <div className="work-img">
                      <img src="assets/img/Industries_Travel_Logistics/service-2.jpg" alt=""
                      style={{height:"490px", width:"100%"}} />
                    </div>
                    <div className="work-content">
                      <div className="content-wrap">
                        <h5>
                          <Link href="/portfolio-details">Maritime</Link>
                        </h5>
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery">Shipping</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Ports</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Navigation</Link>
                          </li>
              ...
              <div className="row mb-80 g-lg-0 gy-5 justify-content-between">
                <div className="col-lg-12">
                  <div className="single-work magnetic-item">
                    <div className="work-img">
                      <img src="assets/img/Industries_Travel_Logistics/service-3.jpg" alt="" 
                      style={{height:"230px", width:"100%"}}/>
                    </div>
                    <div className="work-content">
                      <div className="content-wrap">
                        <h5>
                          <Link href="/portfolio-details">Railway</Link>
                        </h5>
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery">Tracks</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Trains</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Stations</Link>
                          </li>
                        </ul>
                        <div className="view-details-wrap">
                          <Link href="/portfolio-details" className="active">
              ...
              <div className="row  g-lg-0 gy-5 justify-content-between">
                <div className="col-lg-6">
                  <div className="single-work magnetic-item">
                    <div className="work-img">
                      <img src="assets/img/Industries_Travel_Logistics/service-4.jpg" alt="" />
                    </div>
                    <div className="work-content">
                      <div className="content-wrap">
                        <h5>
                          <Link href="/portfolio-details">
                            Digital Transformationg
                          </Link>
                        </h5>
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery">Automation</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Integration</Link>
                          </li>
                          <li>
                ...
                <div className="col-lg-5">
                  <div className="single-work magnetic-item">
                    <div className="work-img">
                      <img src="assets/img/Industries_Travel_Logistics/service-5.jpg" alt=""
                      style={{height:"375px"}} />
                    </div>
                    <div className="work-content">
                      <div className="content-wrap">
                        ...
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery">Returns</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Recycling</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Recovery</Link>
                          </li>
                        </ul>
                        <div className="view-details-wrap">
                          <Link href="/portfolio-details" className="active">
          ...
          <div className="row">
            <div className="col-lg-12 d-flex align-items-center justify-content-between gap-4 flex-wrap text-animation">
              <div className="section-title scroll-sec-title-end">
                ...
                <p>
                  Offering comprehensive services in aviation, maritime, railway
                  operations, digital transformation, and reverse logistics to
                  streamline and innovate travel and logistics solutions
                </p>
              </div>
