        ...
        <div className="row g-4 mb-60 ">
          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              <h2>What’s Current and Future Trends in Travel & Logistics</h2>
              <div className="dash-and-paragraph">
                <div className="dash" />
                <p>
                  Discover how our specialized solutions empower travel and
                  logistics businesses to achieve operational goals and drive
                  industry success.
                </p>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Increasing adoption of digital technologies like IoT, AI, and
                  blockchain to enhance operational efficiency, visibility, and
                  customer experience.
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    <i className="bi bi-plus" /> Revenue
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Emphasizing sustainability with green logistics, carbon
                  footprint reduction, and eco-friendly transport to meet
                  regulations and consumer expectations.
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> Green logistics
                  </li>
                  <li>
                    <i className="bi bi-plus" />
                    Carbon footprint
                  ...
                  <li>
                    <i className="bi bi-plus" /> Eco-friendly
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Rapid integration of e-commerce and digital marketplaces to
                  meet the surge in online shopping and seamless delivery
                  demands
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> Platforms
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Marketplaces
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Seamless
                  </li>
                </ul>
              </div>
            </div>
