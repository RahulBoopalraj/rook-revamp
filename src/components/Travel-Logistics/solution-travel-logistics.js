          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              ...
              <div className="dash-and-paragraph">
                <div className="dash" />
                <p>
                  Cutting-edge solutions transforming travel and logistics,
                  driven by smart technologies and efficient operations.
                </p>
              </div>
            </div>
          </div>
            ...
            <ul className="solution-img-wrapper text-animation">
              <li className="active">
                <div
                  ...
                  style={{
                    backgroundImage: "url(assets/img/Industries_Travel_Logistics/solution-1.jpg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Travel_Logistics/solution-2.jpg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Travel_Logistics/solution-3.jpg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Travel_Logistics/solution-4.jpeg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Travel_Logistics/solution-5.jpeg)",
                  }}
                ></div>
              </li>
            </ul>
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Efficiently manage logistics, inventory, and warehousing
                      to streamline the movement of goods.
                    </p>
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Optimize routes, fleet operations, and last-mile delivery
                      for efficient and timely transportation services.
                    </p>
                    <Link className="explore-btn" href="/service-details">
                      Explore More
                      <svg
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Provide seamless online booking, digital marketplaces for
                      travel services, and e-commerce solutions for logistics.
                    </p>
                    <Link className="explore-btn" href="/service-details">
                      Explore More
                      <svg
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Enhance customer satisfaction with personalized travel
                      itineraries, loyalty programs, and responsive customer
                      support.
                    </p>
                    <Link className="explore-btn" href="/service-details">
                      Explore More
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Utilize IoT for logistics tracking, AI for predictive
                      analytics, and blockchain for supply chain transparency
                      and security.
                    </p>
                    <Link className="explore-btn" href="/service-details">
                      Explore More
