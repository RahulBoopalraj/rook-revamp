        ...
        <div className="row g-4 mb-60">
          ...
          <div className="col-lg-8">
            <div className="section-title two text-animation">
              <h2>
                Transforming Journeys with Innovative Travel & Logistics
                Solutions.
              </h2>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-4 d-lg-flex d-none justify-content-end align-items-start">
            <div className="about-left animet-images magnetic-item pt-30">
              <img src="assets/img/Industries_Travel_Logistics/about-1.jpg" alt="" />
            </div>
          </div>
          <div className="col-lg-8">
            <div className="row g-lg-4 gy-5 align-items-xl-center">
              <div className="col-lg-5">
                <div className="about-right-img animet-images magnetic-item">
                  <img src="assets/img/Industries_Travel_Logistics/about-2.jpg" alt="" />
                </div>
              </div>
              <div className="col-lg-7">
                <div className="about-content text-animation">
                  <p>
                    Transforming travel and logistics through strategic
                    partnerships and cutting-edge technology to meet evolving
                    customer demands and navigate industry shifts with agility,
                    ensuring seamless journeys and operational excellence.
                  </p>
                  <Link href="/about">
                    About More
                    <svg
