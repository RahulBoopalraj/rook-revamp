          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              ...
              <div className="dash-and-paragraph two">
                ...
                <p>
                  Rook leads clients with innovative travel and logistics
                  solutions, enhancing efficiency and driving industry
                  excellence.
                </p>
              </div>
            </div>
              ...
              <div className="swiper-wrapper">
                  ...
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        ...
                        <p>
                          “Rook® for Travel and Logistics has transformed our
                          supply chain management. Their strategic solutions and
                          expert insights have significantly enhanced our
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Enhancing Transportation Efficiency</span>
                        <p>
                          “Thanks to Rook® for Travel and Logistics, our
                          transportation operations are now more streamlined and
                          cost-effective. Their advanced technologies and
                          optimization strategies have greatly improved our
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Innovating Digital Platforms</span>
                        <p>
                          “Rook® for Travel and Logistics' cutting-edge digital
                          platforms have revolutionized our online services.
                          Their expertise has been crucial in expanding our
                          digital presence and improving our customer
                          engagement.”
                        </p>
                        <div className="author-area">
                          <div className="content">
