        ...
        <div className="row g-4">
          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              <h2>Meet our Infrastructure & Construction Clients</h2>
              <div className="dash-and-paragraph two">
                ...
                <p>
                  Who offered innovative solutions in smart tech,
                  sustainability, and efficiency for infrastructure and
              ...
              <div className="swiper-wrapper">
                  ...
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Revolutionizing Construction Projects</span>
                        <p>
                          “Rook® for Infrastructure and Construction has
                          revolutionized our construction projects. Their
                          cutting-edge technology and expert management have
                          streamlined processes and ensured timely completion.”
                        </p>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Enhancing Infrastructure Development</span>
                        <p>
                          “With Rook® for Infrastructure and Construction, our
                          infrastructure development has reached new heights.
                          Their strategic solutions and innovative approaches
                          have significantly improved our efficiency and project
                          outcomes.”
                        </p>
                        <div className="author-area">
                          <div className="content">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Modernizing Urban Development</span>
                        <p>
                          “Rook® for Infrastructure and Construction has been
                          pivotal in modernizing our urban development projects.
                          Their advanced technology and sustainable practices
                          have greatly contributed to the success and
