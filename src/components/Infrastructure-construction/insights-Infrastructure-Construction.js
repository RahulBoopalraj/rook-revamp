      ...
      <div className="container-lg container-fluid">
          ...
          <div className="col-lg-12">
            <div className="section-title text-animation">
              <h2>
                Our Insights <br />
                <span>
                  On the Infrastruture and <br /> Construction
                </span>
              </h2>
              <div className="dash-and-paragraph three">
                ...
                <div className="btn-and-paragraph">
                  ...
                  <p>
                    Discover cutting-edge trends and strategies in
                    infrastructure and construction to drive success and
                    innovation.
                  </p>
                </div>
              </div>
        ...
        <div className="row g-lg-4 gy-5">
          <div className="col-lg-4 col-md-6">
            <div className="blog-card1 magnetic-item">
              <Link href="/blog-details" className="blog-img">
                <img
                  src="assets/img/Industries_Infrastructure_Construction/insights-1.jpeg"
                  alt="blog-img-01"
                />
              </Link>
              <div className="blog-content">
                <h4>
                  <Link href="/blog-details">
                    Harnessing Smart Technology to Revolutionize Urban
                    Infrastructure
                  </Link>
                </h4>
              </div>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="blog-card1 magnetic-item">
              <Link href="/blog-details" className="blog-img">
                <img src="assets/img/Industries_Infrastructure_Construction/insights-2.jpg" alt="blog-img-02"
                style={{height:"280px", width:"100%"}} />
              </Link>
              <div className="blog-content">
                <h4>
                  <Link href="/blog-details">
                    Adopting Sustainable Building Practices for Enhanced
                    Construction Efficie
                  </Link>
                </h4>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="blog-card1 magnetic-item">
              <Link href="/blog-details" className="blog-img">
                <img src="assets/img/Industries_Infrastructure_Construction/insights-3.jpeg" alt="blog-img-03" />
              </Link>
              <div className="blog-content">
                <h4>
                  <Link href="/blog-details">
                    Leveraging Modular Construction to Accelerate Project
