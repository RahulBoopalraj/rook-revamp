        ...
        <div className="row g-4 mb-60 ">
          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              <h2>
                What’s Current and Future Trends in Infrastructure &
                Construction
              </h2>
              <div className="dash-and-paragraph">
                <div className="dash" />
                <p>
                  The industry is advancing with smart tech, green building, and
                  modular construction. Key trends include IoT, sustainability,
                  and efficiency.
                </p>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Smart cities use IoT and AI to enhance urban life with
                  efficient, connected infrastructure, real-time data, and
                  sustainability.
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> IoT
                  </li>
                  <li>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Green building focuses on eco-friendly materials and energy
                  efficiency to reduce environmental impact and promote
                  sustainability.
                </p>
                <ul>
                  <li>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Modular and prefabricated methods streamline construction,
                  speeding up projects and reducing costs.
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> Modular
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Prefabricated
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Efficient
                  </li>
                </ul>
              </div>
            </div>
