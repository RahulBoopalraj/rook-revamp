          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              ...
              <div className="dash-and-paragraph">
                <div className="dash" />
                <p>
                  We build and manage infrastructure, implement smart
                  technology, and provide environmental solutions while securing
            ...
            <ul className="solution-img-wrapper text-animation">
              <li className="active">
                <div
                  ...
                  style={{
                    backgroundImage: "url(assets/img/Industries_Infrastructure_Construction/solution-1.jpg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Infrastructure_Construction/solution-2.jpg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Infrastructure_Construction/solution-3.jpg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Infrastructure_Construction/solution-4.jpg)",
                  }}
                ></div>
              </li>
              <li>
                <div
                  className="solution-img"
                  style={{
                    backgroundImage: "url(assets/img/Industries_Infrastructure_Construction/solution-5.jpg)",
                  }}
                ></div>
              </li>
            </ul>
            ...
            >
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Covers the creation and maintenance of roads, railways,
                      airports, and ports to support transportation and
                      logistics.
                    </p>
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Provides funding and financial models through
                      public-private partnerships and grants for large-scale
                      projects.
                    </p>
                    <Link className="explore-btn" href="/service-details">
                      Explore More
              ...
              <div className="accordion-item">
                <h3 className="accordion-header" id="flush-headingThree">
                  ...
                  >
                    3. BSmart Infrastructure Solutions
                    <span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={10}
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Uses advanced technology for efficient urban systems and
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Offers feasibility studies, design, cost estimation, and
                      oversight to ensure successful project execution.
                    </p>
                    <Link className="explore-btn" href="/service-details">
                      Explore More
                      <svg
              ...
              <div className="accordion-item">
                <h3 className="accordion-header" id="flush-headingFive">
                  ...
                  >
                    5.Environmental and Civil Engineering Solutions
                    <span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={10}
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Manages water, flood control, and soil stability for
