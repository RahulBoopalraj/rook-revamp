        ...
        <div className="row mb-60">
          <div className="col-lg-12 d-flex gap-2 flex-wrap align-items-end justify-content-between">
            ...
            <div className="paragraph text-animation">
              <p>
                At Rook, we offer insightful data analytics case studies and
                problem statements, highlighting real-world business challenges
                and delivering effective, data-driven solutions.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="services-btm">
                  ...
                  <div className="paragraph-img">
                    <p>
                      ...
                      A major retail chain struggled to make sense of its vast
                      customer data, leading to missed opportunities for
                      personalization and ineffective marketing campaigns.
                    </p>
                    <p>
                      <h3>
                        <strong>Solution :</strong>
                      </h3>{" "}
                      Rook implemented Descriptive and Predictive Analytics,
                      providing deep insights into customer behavior and
                      purchasing patterns, while optimizing their marketing
                      strategies.
                    </p>
                    <p>
                      <h3>
                      ...
                      The retailer saw a 20% increase in customer retention and
                      35% improvement in marketing ROI, with more targeted and
                ...
                <div className="services-btm">
                  ...
                  <div className="paragraph-img">
                    <p>
                      ...
                      Inefficient data management and poor performance metrics
                      tracking hindered strategic decision-making, leading to
                    ...
                    <p>
                      ...
                      Rook deployed Data Engineering and Business Intelligence
                      (BI) tools to centralize data, ensuring clean, actionable
                    ...
                    <p>
                      ...
                      The firm experienced a 25% improvement in decision-making
                      speed, with clearer performance metrics and actionable
                      insights driving their strategy forward.
                    </p>
                  </div>
                  <div className="span" />
                </div>
