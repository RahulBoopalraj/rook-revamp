              ...
              <div className="section-title three text-animation">
                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    <p>
                    At Rook, we deliver key data analytics impacts and stats,
                      emphasizing performance improvements and actionable
                      insights for optimal business decisions.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="home2-process-wrapper">
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                      <strong>Reduction in operational costs </strong> through improved
                ...
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        faster <strong>decision-making </strong> by leveraging real-time data insights, allowing companies to respond swiftly to market changes.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong>improvement in marketing ROI </strong>with advanced customer segmentation and personalized campaigns
                      </p>
                    </div>
                  </div>
                </div>
