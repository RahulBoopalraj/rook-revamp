      ...
      if (window.innerWidth > 992) {
        ...
        if (dashboardImgSection) {
          ...
          if (
            ...
            const dashboardImg =
              dashboardImgSection.querySelector(".dashboard-img");
        ...
        <div className="animate-vector">
          ...
          >
            <path
              ...
              id="theMotionPath"
              d="M0 6H280C291.046 6 300 14.9543 300 26V106.94C300 118.009 308.991 126.973 320.06 126.94L468 126.5L636 126"
              stroke="url(#paint0_linear_2866_2312)"
              strokeWidth={2}
            />
            ...
            <path
              className="path-square"
              id="theMotionPath2"
              d="M0 30H280C291.046 30 300 38.9543 300 50V130.94C300 142.009 308.991 150.973 320.06 150.94L636 150"
              stroke="url(#paint1_linear_2866_2312)"
              strokeWidth={2}
            />
            <circle cx={0} cy={0} r={5} className="sm-circle">
              <animateMotion
            ...
            <path
              className="path-square"
              id="theMotionPath3"
              d="M0 54H280C291.046 54 300 62.9543 300 74V154.94C300 166.009 308.991 174.973 320.06 174.94L636 174"
              stroke="url(#paint2_linear_2866_2312)"
              strokeWidth={2}
            />
            <circle cx={0} cy={0} r={5} className="sm-circle">
              <animateMotion
            ...
            <path
              className="path-square"
              id="theMotionPath4"
              d="M0 78H280C291.046 78 300 86.9543 300 98V178.94C300 190.009 308.991 198.973 320.06 198.94L636 198"
              stroke="url(#paint3_linear_2866_2312)"
              strokeWidth={2}
            />
            <circle cx={0} cy={0} r={5} className="sm-circle">
              <animateMotion
        ...
        <div className="animate-vector2">
          ...
          >
            <path
              ...
              id="theMotion1Path"
              d="M0 6H280C291.046 6 300 14.9543 300 26V106.94C300 118.009 308.991 126.973 320.06 126.94L468 126.5L636 126"
              stroke="url(#paint01_linear_2866_2312)"
              strokeWidth={2}
            />
            <circle cx={0} cy={0} r={5} className="sm-circle">
              <animateMotion
            ...
            <path
              ...
              id="theMotion1Path2"
              d="M0 30H280C291.046 30 300 38.9543 300 50V130.94C300 142.009 308.991 150.973 320.06 150.94L636 150"
              stroke="url(#paint11_linear_2866_2312)"
              strokeWidth={2}
            />
            <circle cx={0} cy={0} r={5} className="sm-circle">
              <animateMotion
            ...
            <path
              ...
              id="theMotion1Path3"
              d="M0 54H280C291.046 54 300 62.9543 300 74V154.94C300 166.009 308.991 174.973 320.06 174.94L636 174"
              stroke="url(#paint21_linear_2866_2312)"
              strokeWidth={2}
            />
            <circle cx={0} cy={0} r={5} className="sm-circle">
              <animateMotion
            ...
            <path
              ...
              id="theMotion1Path4"
              d="M0 78H280C291.046 78 300 86.9543 300 98V178.94C300 190.009 308.991 198.973 320.06 198.94L636 198"
              stroke="url(#paint31_linear_2866_2312)"
              strokeWidth={2}
            />
            <circle cx={0} cy={0} r={5} className="sm-circle">
              <animateMotion
          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-12">
              <div className="banner-content-wrapper text-center text-animation">
                ...
                <h1>
                  Your Start up navigator To scale up &amp; Accelerate your idea
                </h1>
                <p>
                  Our services empower ventures with unique solutions for
                  entrepreneurial success, ensuring comprehensive support and
                  strategic growth.
                </p>
                <div className="banner-btn-group">
                  ...
                  <a
                    ...
                    className="primary-btn4 btn-hover two"
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="dashboard-img-wrap">
                <div className="dashboard-img"  style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '600px' }}>
                  <img
                    src="assets/img/Rook-startups/2254-transformed.jpeg"
