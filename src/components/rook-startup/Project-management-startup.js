          ...
          <div className="row mb-70">
            <div className="col-lg-8">
              <div className="section-title3 text-animation">
                ...
                <p>
                  Discover our integrated platform, crafted to simplify your
                  journey by bringing together all essential resources.
                </p>
              </div>
            </div>
          </div>
          <div className="row gy-5 position-relative">
            <div className="col-lg-6">
              <div className="single-project magnetic-item">
                ...
                <div className="single-project-img">
                  <img
                    src="assets/img/Rook-startups/proj-manage-1.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div className="col-lg-6">
              <div className="single-project magnetic-item">
                <div className="content">
                  ...
                  <ul>
                    <li>
                      ...
                      Define an identity reflects values, mission &
                      market edge.
                    </li>
                    <li>
                      <svg
                      ...
                      Build consistency for trust and recognition.
                    </li>
                  </ul>
                  <a href="#">
                    Get Free Trial
                ...
                <div className="single-project-img">
                  <img
                    src="assets/img/Rook-startups/proj-manage-2.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div className="col-lg-6">
              <div className="single-project magnetic-item">
                <div className="content">
                  ...
                  <ul>
                    <li>
                      ...
                      Develop online presence through optimized websites, social
                      media, and content.
                    </li>
                    <li>
                      {" "}
                      ...
                      Engage consistently to build loyalty and increase brand
                      visibility online.
                    </li>
                  </ul>
                  <a href="#">
                ...
                <div className="single-project-img">
                  <img
                    src="assets/img/Rook-startups/proj-manage-3.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div className="col-lg-6">
              <div className="single-project magnetic-item">
                <div className="content">
                  ...
                  <ul>
                    <li>
                      ...
                      Use tools to streamline tasks like email campaigns and
                      social scheduling.
                    </li>
                    <li>
                      <svg
                      ...
                      Implement CRM systems for tracking interactions and
                ...
                <div className="single-project-img">
                  <img
                    src="assets/img/Rook-startups/proj-manage-4.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div className="col-lg-6">
              <div className="single-project magnetic-item">
                <div className="content">
                  ...
                  <ul>
                    <li>
                      ...
                      Conduct market research to understand audience,
                    ...
                    <li>
                      ...
                      Develop clear goals, timelines, and metrics for a
                      successful launch.
                    </li>
                  </ul>
                  <a href="#">
                ...
                <div className="single-project-img">
                  <img src="assets/img/Rook-startups/proj-manage-5.jpg" alt="" />
                </div>
              </div>
            </div>
          </div>
