              ...
              <div className="section-title">
                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    ...
                    <p>
                    Créer un brief de studio de design concis et efficace est essentiel pour décrire votre entreprise et ses services.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="portfolio-card two magnetic-item">
                ...
                <div className="portfolio-content">
                  <h4>
                    ...
                    Une conception intelligente, des solutions encore plus intelligentes.
                    </Link>
                  </h4>
                </div>
              </div>
            ...
            <div className="col-lg-5 col-md-6">
              <div className="portfolio-card two magnetic-item">
                ...
                <div className="portfolio-content">
                  <h4>
                    <Link href="/portfolio-details">
                    Là où la vision rencontre la technologie.
                    </Link>
                  </h4>
                </div>
              </div>
            ...
            <div className="col-lg-12 d-flex justify-content-center">
              <div className="load-more-btn btn_wrapper">
                <button className="circle-btn btn-hover">
                  ...
                  Charger plus <strong>Portefeuille</strong>
