          ...
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-8">
              <div className="section-title text-animation">
                <h2>
                Faisons <strong>Quelque chose de grand ensemble</strong>
                </h2>
                <div className="dash-and-paragraph">
                  <div className="dash" />
                  <div className="content-and-social">
                    <p>
                    En utilisant les approches de conception les plus innovantes et les dernières
technologies, nous créerons un site Web qui représente vraiment
votre marque et vous distingue de la concurrence. Commençons
votre voyage vers le succès avec Rook francias .
                    </p>
                    <Link
                      href="/contact"
