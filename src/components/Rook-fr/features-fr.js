...
const Home2About = () => {
  ...
  return (
    <>
      <div className="home2-about-section  mt-130">
              ...
              <div className="section-title three text-animation">
                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    <p>
                      Nous proposons des conceptions innovantes avec des widgets
                      remarquables, des objets portables métaverse et des mises
                      en page de grille interactives, améliorant l'engagement
                  ...
                  <li className="single-counter">
                    ...
                    <div className="content">
                      <div className="number">
                        <h3 className="counter">Créativité </h3>
                      </div>
                      <p>Designs innovants et hybrides.</p>
                    </div>
                  </li>
                  <li className="single-counter">
                    <div className="icon">
                    ...
                    <div className="content">
                      <div className="number">
                        <h3 className="counter">En-tête et barre latérale </h3>
                      </div>
                      <p>Widgets numériques uniques.</p>
                    </div>
                  </li>
                  <li className="single-counter">
                    <div className="icon">
                    ...
                    <div className="content">
                      <div className="number">
                        <h3 className="counter">5+ Navigation barres</h3>
                      </div>
                      <p>Grilles de contenu et éléments sociaux.</p>
                    </div>
                  </li>
                </ul>
                <Link href="/about">
                ...
                <div className="col-sm-5">
                  <div className="about-left">
                    <div className="about-img animet-images magnetic-item">
                      <img src="assets/img/international/about-1.jpg" alt="" />
                    </div>
                    <p className="text-animation2">
                      Nous créons des produits et des designs de nouvelle
                      génération avec des widgets remarquables et des objets
                      portables métaverse, améliorant l'engagement grâce à des
                      dispositions en grille et des éléments sociaux.
                    </p>
                  </div>
                </div>
                <div className="col-sm-7 d-sm-flex  d-none">
                  <div className="about-right-img animet-images magnetic-item">
                    <img src="assets/img/international/about-2.jpg" alt="" />
                  </div>
                </div>
              </div>
            </div>
