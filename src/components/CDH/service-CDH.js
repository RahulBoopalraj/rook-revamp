            ...
            <div className="col-lg-12">
              <div className="row mb-80 g-lg-0 gy-5 justify-content-between ">
                <div className="col-lg-5">
                  <div className="single-work magnetic-item">
                    <div className="work-img">
                      <img src="assets/img/Industries_CDH/service-1.jpg" alt=""
                      style={{ height: "490px" }} />
                    </div>
                    <div className="work-content">
                      <div className="content-wrap">
                        ...
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery"> Platform</Link>
                          </li>
                          <li>
                ...
                <div className="col-lg-6">
                  <div className="single-work magnetic-item">
                    <div className="work-img">
                      <img src="assets/img/Industries_CDH/service-2.jpeg" alt="" 
                      style={{ height: "490px" }}/>
                    </div>
                    <div className="work-content">
                      <div className="content-wrap">
                        ...
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery">Pricing</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Forecasting</Link>
                          </li>
                          <li>
              ...
              <div className="row mb-80 g-lg-0 gy-5 justify-content-between">
                <div className="col-lg-12">
                  <div className="single-work magnetic-item">
                    <div className="work-img">
                      <img src="assets/img/Industries_CDH/service-3.jpg" alt="" 
                    ...
                    <div className="work-content">
                      <div className="content-wrap">
                        ...
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery">Targeting</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Engagement</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">
                              Customization
              ...
              <div className="row  g-lg-0 gy-5 justify-content-between">
                <div className="col-lg-6">
                  <div className="single-work magnetic-item">
                    <div className="work-img">
                      <img src="assets/img/Industries_CDH/service-4.jpeg" alt="" 
                      style={{ height: "490px" }}/>
                    </div>
                    <div className="work-content">
                      <div className="content-wrap">
                        ...
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery">Analysis</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Trends</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">Decisions</Link>
                          </li>
                        </ul>
                        <div className="view-details-wrap">
                          <Link href="/portfolio-details" className="active">
                ...
                <div className="col-lg-5">
                  <div className="single-work magnetic-item">
                    <div className="work-img">
                      <img src="assets/img/Industries_CDH/service-5.jpg" alt=""
                      style={{ height: "490px" }} />
                    </div>
                    <div className="work-content">
                      <div className="content-wrap">
                        ...
                        <ul>
                          <li>
                            <Link href="/portfolio-manonery">Reporting</Link>
                          </li>
                          <li>
                            <Link href="/portfolio-manonery">
                              Visualization
          ...
          <div className="row">
            <div className="col-lg-12 d-flex align-items-center justify-content-between gap-4 flex-wrap text-animation">
              <div className="section-title scroll-sec-title-end">
                ...
                <p>
                  Our services in Consumer, Hospitality, and Distribution
                  enhance efficiency and elevate customer experiences with
                  tailored solutions.
                </p>
              </div>
