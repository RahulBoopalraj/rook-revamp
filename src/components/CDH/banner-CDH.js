            ...
            <div className="col-lg-12">
              <div className="banner-main-title">
                <h6 className="text-animation">
                  Consumer, Distribution & Hospitality
                  <svg
                ...
                <h1 className="text-animation">
                  <span>Service.</span>Supply. Comfort.
                </h1>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-lg-7 d-lg-flex d-none pt-3">
                <div className="banner-img magnetic-item pt-3">
                  <img src="assets/img/Industries_CDH/banner.jpg" alt="" 
              ...
              <div className="col-lg-5">
                <div className="banner-right-content">
                  <div className="content">
                    <p>
                      Empower success with seamlessWe provide cutting-edge
                      services and solutions at Rook, tailored for the
                      <span>
                        {" "}
                        Consumer, Distribution, and Hospitality industries
                      </span>{" "}
