        ...
        <div className="row g-4 mb-60 ">
          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              <h2>
                What’s Current and Future Trends in Construction , Distribution
                & Hospitality
              </h2>
              <div className="dash-and-paragraph">
                <div className="dash" />
                <p>
                  Current and future trends include sustainability, advanced
                  materials, and modular builds in construction; automation and
                  AI logistics in distribution; and personalized experiences,
                  smart tech, and sustainability in hospitality.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="row g-lg-4 gy-5">
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Focus on green materials and energy-efficient designs to
                ...
                <ul>
                  ...
                  <li>
                    <i className="bi bi-plus" /> Innovative
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Integration of automated systems and robotics to enhance
                ...
                <ul>
                  ...
                  <li>
                    <i className="bi bi-plus" /> Cost-saving
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                <h3>
                  Personalized Guest <br />
                  Experiences
                </h3>
                <p>
                  Use of AI and data analytics to tailor services and improve
                  guest satisfaction.
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> Tailored
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Insightful
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Engaging
                  </li>
                </ul>
              </div>
            </div>
