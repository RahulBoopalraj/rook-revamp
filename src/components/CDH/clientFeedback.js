          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              ...
              <div className="dash-and-paragraph two">
                ...
                <p>
                  Rook leads clients with innovative solutions in consumer,
                  distribution, and hospitality, enhancing service delivery and
              ...
              <div className="swiper-wrapper">
                  ...
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Transforming Consumer Engagement</span>
                        <p>
                          “Rook® for Consumer, Distribution & Hospitality has
                          transformed our consumer engagement strategies. Their
                          innovative approaches and expert insights have
                          significantly boosted our customer satisfaction and
                          loyalty.”
                        </p>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Optimizing Distribution Networks</span>
                        <p>
                          “With Rook® for Consumer, Distribution & Hospitality,
                          our distribution networks are now more efficient and
                          reliable. Their strategic solutions and advanced
                          technologies have greatly improved our supply chain
                          management.”
                        </p>
                        <div className="author-area">
                          <div className="content">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Elevating Hospitality Services</span>
                        <p>
                          “Rook® for Consumer, Distribution & Hospitality has
                          elevated our hospitality services to new heights.
                          Their cutting-edge solutions and focus on guest
                          experience have been instrumental in enhancing our
