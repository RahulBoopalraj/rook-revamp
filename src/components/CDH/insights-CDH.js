          ...
          <div className="col-lg-12">
            <div className="section-title text-animation">
              <h2>
                Our Insights <br />
                <span>
                  On the Consumer , Distribution and <br /> Hospitality
                </span>
              </h2>
              ...
              <div className="blog-content">
                <h4>
                  <Link href="/blog-details">
                    Implementing Advanced Automation and Robotics to
                    Revolutionize Efficiency in Supply Chain Management
                  </Link>
                </h4>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="blog-card1 magnetic-item">
              ...
              <div className="blog-content">
                <h4>
                  <Link href="/blog-details">
                    Utilizing Artificial Intelligence to Create
                    Hyper-Personalized Experiences and Elevate Service Standards
                  </Link>
                </h4>
              </div>
            </div>
