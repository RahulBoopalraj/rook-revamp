        ...
        <div className="row g-4 mb-60">
          ...
          <div className="col-lg-8">
            <div className="section-title two text-animation">
              <h2>
                Rook transforms D2C education disruptions into opportunities for
                brand growth.
              </h2>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-4 d-lg-flex d-none justify-content-end align-items-start">
            <div className="about-left animet-images magnetic-item pt-30">
              <img src="assets/img/Industries_Education/about-1.jpg" alt="" />
            </div>
          </div>
          <div className="col-lg-8">
            <div className="row g-lg-4 gy-5 align-items-xl-center">
              <div className="col-lg-5">
                <div className="about-right-img animet-images magnetic-item">
                  <img src="assets/img/Industries_Education/about-2.jpg" alt="" />
                </div>
              </div>
              <div className="col-lg-7">
                <div className="about-content text-animation">
                  <p>
                    As education evolves with new technologies and learning
                    models, Rook utilizes these advancements to elevate D2C
                    brand strategies and drive growth.
                  </p>
                  <Link href="/about">
                    About More
                    <svg
