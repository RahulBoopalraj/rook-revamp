        ...
        <div className="row g-4">
          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              <h2>Meet our Educational Clients</h2>
              <div className="dash-and-paragraph two">
                ...
                <p>
                  who offer tailored strategies and innovative solutions for
              ...
              <div className="swiper-wrapper">
                  ...
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Transforming Educational Outcomes</span>
                        <p>
                          “Rook® for Education has been instrumental in
                          advancing our learning strategies. Their innovative
                          solutions and tailored approaches have significantly
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Expanding Learning Horizons</span>
                        <p>
                          “Thanks to Rook® for Education, our educational reach
                          has grown exponentially. Their expertise in digital
                          learning platforms and educational technology has
                          greatly expanded our ability to deliver high-quality
                          education.”
                        </p>
                        <div className="author-area">
                          <div className="content">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="row g-lg-4 gy-5">
                    ...
                    <div className="col-lg-7">
                      <div className="testimonal-content">
                        <span>Innovating Teaching Methods</span>
                        <p>
                          “Rook® for Education’s state-of-the-art solutions and
                          strategic support have transformed our teaching
                          methods. Their guidance has been essential in
                          achieving improved educational outcomes and fostering
