          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              ...
              <div className="dash-and-paragraph">
                <div className="dash" />
                <p>
                  Rook delivers advanced virtual classroom solutions, seamless
                  EdTech integration, and student success management with
                  data-driven analytics and insights for growth.
                </p>
              </div>
            </div>
          </div>
            ...
            >
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Immersive online learning environments with live classes,
                      virtual labs, and collaboration.
                    </p>
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Seamless implementation and optimization of digital tools,
              ...
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Comprehensive services for tracking progress, providing
                      support, and success coaching.
                    </p>
                    <Link className="explore-btn" href="/service-details">
                      Explore More
                      <svg
              ...
              <div className="accordion-item">
                <h3 className="accordion-header" id="flush-headingFour">
                  ...
                  >
                    4. Educational Analytics and Insights
                    <span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={10}
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Data-driven solutions for performance improvement,
              ...
              <div className="accordion-item">
                <h3 className="accordion-header" id="flush-headingFive">
                  ...
                  >
                    5.Cyber Security for Education
                    <span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width={10}
                ...
                >
                  <div className="accordion-body">
                    ...
                    <p>
                      Rook Cyber Security for Education provides tailored
                      protection for digital environments and data privacy.
                    </p>
                    <Link className="explore-btn" href="/service-details">
                      Explore More
                      <svg
