      ...
      <div className="container-lg container-fluid">
            ...
            <div className="section-title text-animation">
              ...
              <div className="dash-and-paragraph three">
                ...
                <div className="btn-and-paragraph">
                  ...
                  <p>
                    Discover our expert insights and trends in education to
                    drive success and innovation for your institution.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="row g-lg-4 gy-5">
          <div className="col-lg-4 col-md-6">
            <div className="blog-card1 magnetic-item">
              <Link href="/blog-details" className="blog-img">
                <img src="assets/img/Industries_Education/insights-1.jpeg" alt="blog-img-01"
                style={{height:"300px", width:"100%"}} />
              </Link>
              <div className="blog-content">
                <h4>
                  <Link href="/blog-details">
                    How Innovative EdTech Solutions Are Shaping the Future of
                    K-12 Education
                  </Link>
                </h4>
              </div>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="blog-card1 magnetic-item">
              <Link href="/blog-details" className="blog-img">
                <img src="assets/img/Industries_Education/insights-2.jpeg" alt="blog-img-02"
                 style={{height:"300px", width:"100%"}} />
              </Link>
              <div className="blog-content">
                <h4>
                  <Link href="/blog-details">
                    The Role of Data Analytics in Personalizing Higher Education
                    Experiences
                  </Link>
                </h4>
              </div>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="blog-card1 magnetic-item">
              <Link href="/blog-details" className="blog-img">
                <img src="assets/img/Industries_Education/insights-3.jpg" alt="blog-img-03" 
                style={{height:"300px", width:"100%"}}/>
              </Link>
              <div className="blog-content">
                <h4>
                  <Link href="/blog-details">
                    How Virtual Reality is Revolutionizing Hands-On Learning for
                    College Students
                  </Link>
                </h4>
              </div>
