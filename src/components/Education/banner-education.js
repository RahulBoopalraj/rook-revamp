          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="banner-main-title">
                <h6 className="text-animation">Education
                ...
                <h1 className="text-animation"><span>Smart</span> Education Solutions.</h1>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="col-lg-5">
                <div className="banner-right-content">
                  <div className="content">
                    <p>Rook delivers state-of-the-art EdTech solutions to create
                      <span> dynamic and interactive</span> learning environments.
                    </p>
