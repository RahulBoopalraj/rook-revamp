        ...
        <div className="row g-4 mb-60 ">
          ...
          <div className="col-lg-8">
            <div className="section-title text-animation">
              <h2>What’s Current and Future Trends in Education</h2>
              <div className="dash-and-paragraph">
                <div className="dash" />
                <p>
                  Explore how our tailored solutions have empowered educational
                  institutions to achieve their goals and drive success.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="row g-lg-4 gy-5">
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                <h3>Personalized <br />Learning</h3>
                <p>
                  Adapting educational experiences to meet individual student
                  needs and learning styles through technology and data-driven
                  insights.
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> Adaptive Technologies
                  </li>
                  <li>
                  ...
                  <li>
                    <i className="bi bi-plus" /> Data Analytics
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                <h3>EducationTech Innovations</h3>
                <p>
                  Leveraging new technologies like AI, VR, and AR to enhance
                  teaching methods and learning experiences effectively and
                  seamlessly.
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> Artificial Intelligence
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Augmented Reality
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Virtual Reality
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="single-process">
              ...
              <div className="content">
                ...
                <p>
                  Incorporating game design elements into educational content to
                  boost student motivation and engagement.
                </p>
                <ul>
                  <li>
                    <i className="bi bi-plus" /> Game Mechanics
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Motivation
                  </li>
                  <li>
                    <i className="bi bi-plus" /> Engagement
                  </li>
                </ul>
              </div>
            </div>
