          ...
          <div className="col-lg-9">
            <div className="paragraph-and-review">
              <div className="text-animation">
                <p>
                  {" "}
                  See How Rook Branding Transformed Our Clients' Vision into
                  Reality.
                </p>
              </div>
                  ...
                  <div className="row g-4">
                    ...
                    <div className="col-lg-9">
                      <div className="testimonal-content">
                        ...
                        <p>
                          Rook Branding played a crucial role in our success.
                          Their expert guidance and unwavering support provided
                          invaluable insights that truly made a difference.
                        </p>
                  ...
                  <div className="row g-4">
                    ...
                    <div className="col-lg-9">
                      <div className="testimonal-content">
                        ...
                        <p>
                          Working with Rook Branding has been transformative for
                          our online presence. Their professional and responsive
                          approach not only boosted our visibility but also our
                          confidence.
                        </p>
                        <div className="author-area">
                          <div className="content">
                  ...
                  <div className="row g-4">
                    ...
                    <div className="col-lg-9">
                      <div className="testimonal-content">
                        ...
                        <p>
                          Rook Branding didn't just meet our expectations; they
                          exceeded them. Their strategic advice and clear
                          direction were key in bringing my startup vision to
                          life.
                        </p>
                        <div className="author-area">
                          <div className="content">
