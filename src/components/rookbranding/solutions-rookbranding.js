...
const Home4ProcessSection = ({ style }) => {
  return (
    <div className={`home4-process-section mb-130 ${style}`}>
          ...
          <div className="col-xl-9">
            <div className="paragraph-and-btn">
              <div className="text-animation">
                <p>
                  Create unique brand identities and customized solutions to
            ...
            <div className="row gy-5">
              <div className="col-lg-4 col-sm-6">
                <div className="single-process magnetic-item">
                  ...
                  <div className="process-content">
                    <p>
                      Research vision, values, audience, and competitors
                      comprehensively.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-sm-6">
                <div className="single-process two magnetic-item">
                  <div className="work-step">
                    <span>Step: 02</span>
                  </div>
                  <div className="icon-and-title">
              ...
              <div className="col-lg-4 col-sm-6">
                <div className="single-process three magnetic-item">
                  <div className="work-step">
                    <span>Step: 03</span>
                  </div>
                  <div className="icon-and-title">
                  ...
                  <div className="process-content">
                    <p>
                      Execute brand strategy effectively for lasting market
                      impact.
                    </p>
                  </div>
                </div>
