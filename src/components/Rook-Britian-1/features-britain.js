              ...
              <div className="section-title three text-animation">
                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    <p>
                      We deliver innovative designs with standout widgets,
                      metaverse wearables, and interactive grid layouts,
                      enhancing user engagement across your site.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="counter-and-btn">
                <ul className="counter-wrap">
                  <li className="single-counter">
                    ...
                    <div className="content">
                      <div className="number">
                        <h3 className="counter">Creativity</h3>
                      </div>
                      <p>Innovating future products and designs.</p>
                    </div>
                  </li>
                  <li className="single-counter">
                    <div className="icon">
                    ...
                    <div className="content">
                      <div className="number">
                        <h3 className="counter">Unique Header & Sidebar</h3>
                      </div>
                  ...
                  <li className="single-counter">
                    ...
                    <div className="content">
                      <div className="number">
                        <h3 className="counter">5+ Navigation Bars</h3>
                      </div>
                      <p>Grid layouts enhance user interaction.</p>
                    </div>
                  </li>
                </ul>
                <Link href="/about">
                ...
                <div className="col-sm-5">
                  <div className="about-left">
                    <div className="about-img animet-images magnetic-item">
                      <img src="assets/img/international/about-1.jpg" alt="" className=" rounded-3 "/>
                    </div>
                    <p className="text-animation2">
                      We create next-gen products and designs with standout
                      widgets and metaverse wearables, enhancing engagement
                      through grid layouts and social elements.
                    </p>
                  </div>
                </div>
