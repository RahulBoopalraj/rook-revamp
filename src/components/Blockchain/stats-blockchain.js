              ...
              <div className="section-title three text-animation">
                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    <p>
                      At Rook, we enhance cognitive business operations with
                      impactful decision-making, automation, and data insights
                      to boost productivity and streamline processes.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="home2-process-wrapper">
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong>Increase in operational efficiency </strong> through Intelligent Process Automation (RPA), reducing manual effort and errors.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong> Boost in customer satisfaction </strong>with Cognitive Customer Experience, driven by personalized and AI-enhanced interactions.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong>Improvement in decision-making speed </strong>with Operations Analytics, providing actionable insights and optimizing performance.
                      </p>
                    </div>
                  </div>
                </div>
