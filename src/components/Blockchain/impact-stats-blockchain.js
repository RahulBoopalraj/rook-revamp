                ...
                <div className="dash-and-paragraph">
                  ...
                  <div className="paragraph-and-btn">
                    <div className="text-animation">
                      <p>
                        {" "}
                        At Rook, we provide precise blockchain solutions,
                        enhancing security, transparency, and efficiency to help
                        businesses streamline operations and protect data
                        integrity.
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="row g-lg-4 gy-5">
                        <div className="col-lg-5">
                          <div className="testimonial-img-wrap px-5">
                            <div className="testimonial-img">
                              <img
                                src="assets/img/blockchain/stats.jpg"
                                style={{height:"500px"}}
                                alt=""
                              />
                            </div>
                        ...
                        <div className="col-lg-7">
                          <div className="testimonial-content-wrapper">
                            <p>
                              Our blockchain solutions ensure full transparency,
                              reduce manual errors, improve data integrity, and
                              offer secure crypto asset storage for peace of
                              mind.
                            </p>
                            <ul className="counter-wrap">
                              <li className="single-counter">
                                <div className="content">
                                  <div className="number">
                                    ...
                                    <h3 className="counter">99</h3>
                                    <span>%</span>
                                  </div>
                                  <p>
                                    Transparency <br /> achieved
                                  </p>
                                </div>
                              </li>
                              <li className="single-counter">
                              ...
                              <li className="single-counter">
                                <div className="content">
                                  ...
                                  <p>secure crypto asset storage</p>
                                </div>
                              </li>
                            </ul>
                          </div>
