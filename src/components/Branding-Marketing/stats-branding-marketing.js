              ...
              <div className="section-title three text-animation">
                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    <p>
                      At Rook, we deliver key branding and marketing impacts and
                      stats, focusing on increased brand visibility, customer
                      engagement, and strategic growth to help businesses
              ...
              <div className="home2-process-wrapper">
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong>Increase </strong>  in customer engagement through our tailored UI/UX design solutions, driving better user experiences across digital platforms.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong> Boost in brand visibility</strong>using our targeted digital marketing campaigns, helping businesses reach and attract more customers.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong>Improvement in brand </strong>recognition and loyalty with our comprehensive brand development strategies.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="single-process-static">
                  <div className="single-process">
                    ...
                    <div className="content">
                      <p>
                        <strong> Increase in website </strong> traffic through our data-driven content marketing and SEO solutions, generating more leads and conversions.
                      </p>
                    </div>
                  </div>
                </div>
