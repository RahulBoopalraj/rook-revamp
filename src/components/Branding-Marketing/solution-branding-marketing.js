...
import portfolioShowcaseData from "../../data/solution-branding-marketing.json";
              ...
              <div className="section-title">
                ...
                <div className="dash-and-paragraph three">
                  ...
                  <div className="btn-and-paragraph">
                    <p className="px-4">
                      At Rook, we offer secure and transparent blockchain
                      solutions, helping businesses streamline transactions and
